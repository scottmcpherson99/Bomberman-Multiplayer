#undef BOMBERMANMULTIPLAYER_API
...
#define UE_PROJECT_NAME BombermanMultiplayer
#define UE_TARGET_NAME BombermanMultiplayerEditor
...
#define BOMBERMANMULTIPLAYER_API DLLEXPORT
